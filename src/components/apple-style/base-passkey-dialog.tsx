  ...
  return (
    <div
      ...
      >
        ...
        <div className="w-full h-[1px] bg-[#3a3a3c] mb-4" />
        
        {/* Content */}
        <div className="flex flex-col items-center cursor-default gap-4">
          <div className="w-14 h-14 apple-dialog-icon-container flex items-center justify-center mb-2">
            <RubiksCubeIcon className="w-12 h-12" />
          </div>
          ...
          {description && (
            <p className="apple-dialog-description text-center text-sm mb-2">
              {description}
            </p>
          )}
          ...
          {!isConnected && !connectionFailed && (
            <div className="text-center my-4 text-sm text-[#8e8e93]">
          ...
          {connectionFailed && (
            <button
              onClick={onConnect}
              className="w-full py-3 rounded-md bg-[#4285f4] text-white font-medium text-sm">
              Connect to Cube
            </button>
          )}
